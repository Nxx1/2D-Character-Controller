...
{
    public RunState(CharacterControllerStateMachine characterControllerStateMachine) : base("Run", characterControllerStateMachine)
    {
    ...
    public override void UpdateAnimation()
    {
        ...
        _characterControllerStateMachine.animator.SetBool("Glide", false);
